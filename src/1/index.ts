...
export const find2 = <Sum, Values extends readonly number[]>(target: Sum, evaluate: (v1: Values[number], v2: Values[number]) => Sum, values: Values): [Values[number], Values[number]] | undefined => {
...
export const find3 = <Sum, Values extends readonly number[]>(target: Sum, evaluate: (v1: Values[number], v2: Values[number], v3: Values[number]) => Sum, values: Values): [Values[number], Values[number], Values[number]] | undefined => {
  for (const v1 of values) {
    for (const v2 of values) {
